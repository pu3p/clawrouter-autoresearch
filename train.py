...
DOMAIN_KEYWORDS = {
    "stem": [
        "equation", "calculate", "algorithm",
        "theorem", "integral", "derivative", "matrix",
    ...
    "social_sciences": [
        ...
        "geography", "population", "urban", "rural", "climate",
        "public relations", "communication",
        "diplomacy", "international",
        "economic", "macroeconomic", "microeconomic", "recession", "interest rate",
        "political science", "congress", "senate", "parliament",
        ...
        "security", "terrorism", "deterrence", "proliferation",
        "humanitarian", "refugee", "asylum",
        "ballot", "partisan",
    ...
    "other": [
        ...
        "management", "marketing", "accounting", "audit",
        "nutrition", "vitamin", "diet", "calorie", "protein",
        "aging", "genetic", "mutation", "virus", "infection",
        "medical", "physician", "hospital", "healthcare", "prescription",
        "syndrome", "pathology", "epidemiology", "immunology", "pharmacology",
        "corporate", "entrepreneur", "revenue", "expense",
        "finance", "investment", "stock", "portfolio", "dividend",
