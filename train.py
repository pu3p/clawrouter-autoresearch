...
SUBJECT_PATTERNS = {
    ...
    "high_school_psychology_strong": {
        ...
        "signals": ["capital punishment", "person diagnosed",
                     ...
                     "sensory memory",
                     "method of loci", "babinski", "moro",
                     "cross-sectional studies", "cerebral cortex",
                     "amygdala", "hippocampus", "latent learning",
                     "opponent process", "psychoanalytic perspective",
                     "naturalistic observation", "quasi-experimental",
                     "norepinephrine", "piaget",
                     "sensory adaptation", "absolute threshold"],
        "min_signals": 1,
    },
